        ...
        <Flex className="w-full">
            ...
            <Flex className="w-full lg:w-[85%] flex-col">
                ...
                <Container className="py-10 lg:!px-20 flex flex-col">
                    ...
                    {
                        data.details.map((detail, index) => <Box className='mt-10' key={index}>
                            <span className="text-2xl font-semibold">{detail.subTitle}</span> <br />
                            ...
                            {detail.codes.map(({ code, fileName }, index) => (
                                <Box key={index} className="bg-secondary rounded-xl mt-10 pb-3">
                                    <Flex className="justify-between p-2 items-center">
                                        ...
                                        <Flex className="pr-4">
                                            <Button onClick={() => window.open(code)} variant="text" className="text-tint"><IoLogoGithub className="text-xl" /> View on github</Button>
                                        </Flex>
                                    </Flex>
